 ...
 */
    ...
    // Check if multiple boards are enabled
        ...
        + defined(BOARD_VIEWE_SMARTRING_PLUS_A) \
        + defined(BOARD_VIEWE_SMARTRING_PLUS_B) \
    ...
    #elif defined(BOARD_VIEWE_SMARTRING_PLUS_A)
        #include "viewe/BOARD_VIEWE_SMARTRING_PLUS_A.h"
    #elif defined(BOARD_VIEWE_SMARTRING_PLUS_B)
        #include "viewe/BOARD_VIEWE_SMARTRING_PLUS_B.h"
