...
static const char *TAG = "SmartRing_Plus";

// 屏幕版本选择宏定义
// 通过设置以下宏为 1 或 0 来选择屏幕版本
// SMARTRING_PLUS_A = 1, SMARTRING_PLUS_B = 0  -> 使用老屏幕版本（旧屏幕初始化）
// SMARTRING_PLUS_A = 0, SMARTRING_PLUS_B = 1  -> 使用新屏幕版本（新屏幕初始化）
// 注意：只能将其中一个宏设置为 1，另一个必须为 0
#ifndef SMARTRING_PLUS_A
#define SMARTRING_PLUS_A    0  // 老屏幕版本，设置为 1 启用，0 禁用
#endif
#ifndef SMARTRING_PLUS_B
#define SMARTRING_PLUS_B    1  // 新屏幕版本（默认），设置为 1 启用，0 禁用
#endif

// 检查宏定义是否有效
#if (SMARTRING_PLUS_A == 1 && SMARTRING_PLUS_B == 1)
#error "SMARTRING_PLUS_A and SMARTRING_PLUS_B cannot both be 1; please set only one of them to 1."
#elif (SMARTRING_PLUS_A == 0 && SMARTRING_PLUS_B == 0)
#error "SMARTRING_PLUS_A and SMARTRING_PLUS_B cannot both be 0. Please set one of them to 1."
#endif
/** @cond */
